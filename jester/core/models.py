...
class GeneratedCode:
    ...
    code_id: str = field(default_factory=lambda: str(uuid.uuid4())[:8])
...
class ValidationResult:
    ...
    execution_stats: Dict[str, Any] = field(default_factory=dict) # NEW: Performance metrics
    feedback: str = "" # NEW: Feedback for optimization
    timestamp: datetime = field(default_factory=datetime.now)
